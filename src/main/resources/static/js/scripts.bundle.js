...
var KTApp = function () {
    ...
    var initFileInput = function () {
        ...
        $('.custom-file-input').on('change', function () {
            ...
            fileName = $(this).val().length > 0 ? $(this).val().substring($(this).val().lastIndexOf("\\") + 1, $(this).val().length) : 'Ningún archivo seleccionado';
            $($('.custom-file-label')[0]).addClass("selected").html(fileName);
        });
    }
