...
@Component
public class ResetPassByLogin implements Estrategy {

    private static final Log logger = LogFactory.getLog(ResetPassByLogin.class);
    ...
    public ResponseEntity<ResponseRestAPI> execute(Object object) {
        ...
        try {
            ...
            Email email = new Email(presentedEmail, "Restablecer contraseña de cuenta GRisk", textResetPass, htmlResetPass);
            logger.error("********** SEND REQUEST EMAIL API: " +email.toString()+" *************************");
